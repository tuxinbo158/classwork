      $(function () {
        ...
        $("#right>li").mouseenter(function () {
          $("#center>li").eq($(this).index() + 3).show().siblings().hide();
        });
//      焦点图部分
...
var $li = $("#box li");
    ...
    $li.mouseenter(function () {
      $(this).stop().animate({width:800,height:500}).siblings().stop().animate({width:80,height:500});
      
    }).mouseleave(function () {
      $li.stop().animate({width:170,height:500});
    });
